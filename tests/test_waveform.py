...
from dsp.ofdm import frame_sample_count
...
from modem import AURORA_ROBUST_MODE, AURORA_SINGLE_CARRIER_RESEARCH_MODE


class WaveformTests(unittest.TestCase):
    def test_archived_single_carrier_mode_has_exact_audio_sampling_ratio(self) -> None:
        self.assertEqual(samples_per_symbol(AURORA_SINGLE_CARRIER_RESEARCH_MODE), 384)
    ...
    def test_modulation_is_deterministic_finite_and_does_not_clip(self) -> None:
        ...
        self.assertEqual(first.frame_count, frame_sample_count(len(symbols)))
    ...
    def test_clean_symbols_round_trip_after_leading_silence(self) -> None:
        ...
        self.assertGreater(result.diagnostics.sync_metric, 0.65)
